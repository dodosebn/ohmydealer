...
const Header = () => {
  ...
  return (
    <div className='bg-white h-16 px-4 w-full flex justify-between items-center border-b border-gray-200'>
      {/* Search Input with Icon */}
      <div className='relative'>
        <HiOutlineSearch fontSize={20} className='text-gray-400 absolute top-2/4 transform -translate-y-2/4 left-3' />
        <input 
          type="text"
          placeholder='Search...'
          className='text-sm focus:outline-none h-9 w-[24rem] border border-gray-200 rounded-lg pl-10 pr-4'
        />
      </div>
        ...
        <Menu as="div" className="relative inline-block text-left">
          <MenuButton className="inline-flex items-center gap-2 rounded-md bg-gray-800 py-1.5 px-3 text-sm font-semibold text-white shadow-inner shadow-white/10 focus:outline-none">
            <div
              ...
              className="bg-sky-500 bg-cover w-[40px] h-[40px] bg-no-repeat bg-center"
            >
